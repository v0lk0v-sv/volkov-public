...
const AreaChart = factory((_props, ref) => {
  ...
  const areas = series.map((item) => {
    ...
    const color = getThemeColor(item.color, theme);
    const dimmed = shouldHighlight && highlightedArea !== item.name;
    return /* @__PURE__ */ React.createElement(Fragment, { key: item.name }, /* @__PURE__ */ React.createElement("defs", null, /* @__PURE__ */ React.createElement(
      AreaGradient,
      {
        color,
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(ResponsiveContainer, { ...getStyles("container") }, /* @__PURE__ */ React.createElement(
      AreaChart$1,
      {
        data,
      ...
      referenceLinesItems,
      withLegend && /* @__PURE__ */ React.createElement(
        Legend,
        {
          verticalAlign: "top",
      ...
      /* @__PURE__ */ React.createElement(
        ...
        xAxisLabel && /* @__PURE__ */ React.createElement(Label, { position: "insideBottom", offset: -20, fontSize: 12, ...getStyles("axisLabel") }, xAxisLabel),
        xAxisProps?.children
      ),
      /* @__PURE__ */ React.createElement(
        YAxis,
        ...
        yAxisLabel && /* @__PURE__ */ React.createElement(
          Label,
          {
            position: "insideLeft",
            angle: -90,
      ...
      withTooltip && /* @__PURE__ */ React.createElement(
        Tooltip,
        {
          ...
          content: ({ label, payload }) => /* @__PURE__ */ React.createElement(
            ChartTooltip,
            {
              label,
              payload,
      ...
      type === "split" && /* @__PURE__ */ React.createElement("defs", null, /* @__PURE__ */ React.createElement(
        AreaSplit,
        {
          colors: splitColors,
          id: splitId,

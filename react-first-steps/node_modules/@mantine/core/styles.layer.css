...
.m-96b553a6 {
  ...
  .m-96b553a6:where([data-initialized]) {
    transition-duration: var(--transition-duration);
  }

  .m-96b553a6:where([data-hidden]) {
...
.m-cf365364:where([data-initialized]) .m-1738fcb2:where([data-active])::before {
        display: none;
      }

.m-1738fcb2:where([data-active])::before {
      content: '';
      inset: 0;
      z-index: 0;
      position: absolute;
...
:where([data-mantine-color-scheme='light']) .m-1738fcb2:where([data-active])::before {
        box-shadow: var(--sc-shadow, none);
        background-color: var(--sc-color, var(--mantine-color-white));
}

:where([data-mantine-color-scheme='dark']) .m-1738fcb2:where([data-active])::before {
        box-shadow: none;
        background-color: var(--sc-color, var(--mantine-color-dark-5));
}

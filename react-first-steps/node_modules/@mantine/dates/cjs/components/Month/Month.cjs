...
const Month = core.factory((_props, ref) => {
  ...
  const rows = dates.map((row, rowIndex) => {
    ...
    return /* @__PURE__ */ React__default.default.createElement("tr", { key: rowIndex, ...getStyles("monthRow") }, cells);
  });
  return /* @__PURE__ */ React__default.default.createElement(core.Box, { component: "table", ...getStyles("month"), size, ref, ...others }, !hideWeekdays && /* @__PURE__ */ React__default.default.createElement("thead", { ...getStyles("monthThead") }, /* @__PURE__ */ React__default.default.createElement(
  ...
  )), /* @__PURE__ */ React__default.default.createElement("tbody", { ...getStyles("monthTbody") }, rows));
});

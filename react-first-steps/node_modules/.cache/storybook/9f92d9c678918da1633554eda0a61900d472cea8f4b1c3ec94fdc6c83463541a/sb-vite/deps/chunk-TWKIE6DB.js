...
var LazySyntaxHighlighter = (0, import_react.lazy)(async () => {
  let { SyntaxHighlighter: SyntaxHighlighter3 } = await import("./syntaxhighlighter-JOJW2KGS-N3OKWUYN.js");
...
var LazySyntaxHighlighterWithFormatter = (0, import_react.lazy)(async () => {
  let [{ SyntaxHighlighter: SyntaxHighlighter3 }, { formatter }] = await Promise.all([import("./syntaxhighlighter-JOJW2KGS-N3OKWUYN.js"), import("./formatter-B5HCVTEV-3ISIVAOV.js")]);
  return languages.length > 0 && (languages.forEach((args) => {
    SyntaxHighlighter3.registerLanguage(...args);
...
//# sourceMappingURL=chunk-TWKIE6DB.js.map
